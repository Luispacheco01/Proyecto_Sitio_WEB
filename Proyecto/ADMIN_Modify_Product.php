<?php 
	...
	$objDB=new BaseDatos();
		...
		if(isset($_POST["actualizar"])){
			...
			if($objDB->ModificarProducto($ID, $nombre, $descripcion, $precio, $cantidad, $imagen)==true){
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="form-contactanos">
					<h2 class="text-center"><b>Actualizar Producto</b></h2>
					<br>
						...
						<form action="" method="post" class="form-horizontal" autocomplete="off" autocomplete="nope" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									<input type='text' class='form-control' name='nombre' required='' placeholder='Introduce nombre del producto' id="campos" value="<?php echo $row['Nombre']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									<textarea  name="descripcion" id="campos" rows="3" placeholder="Descripción del producto (máximo 70 caracteres)" maxlength="70" required class="form-control"><?php echo $row['Descripcion']; ?></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									<input type='number' class='form-control' name='precio' required min="0.00" pattern="^[0-9]+" step="0.01" id="campos" value="<?php echo $row['Precio']; ?>">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									<input type='number' class='form-control' name='cantidad' required min="1" pattern="^[0-9]+" step="1" id="campos" value="<?php echo $row['Cantidad']; ?>">
								</div>
							</div>

							<div class="form-group">
								<label for="nombre" class="control-label col-xs-12 col-sm-3 col-md-3 col-lg-3">Imagen Actual:</label>
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
									<img height="125px" src="data:image/jpg;base64,<?php echo base64_encode($row['imagen']); ?>">
								</div>
							</div>

							<div class="form-group">
								<label for="nombre" class="control-label col-xs-12 col-sm-3 col-md-3 col-lg-3">Imagen Nueva:</label>
								<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
							...
							<div class="form-group">
								<div class="col-xs-12 col-sm-offset-2 col-sm-8 col-md-offset-4 col-md-8 col-lg-offset-4 col-lg-8">
									<button type="submit" class="btn btn-primary btn-lg btn-block" id="actualizar" name="actualizar"><span class="glyphicon glyphicon-ok"></span>&nbsp&nbsp&nbspGuardar Producto</button>
